...
class InverseKinematics:
    ...
    def local_translation_engine(self, legs_xyz):
        ...
        try:
            ...
            print(theta_s)
            self.kit.servo[0].angle = 180-(theta_w*100-90)
            self.kit.servo[1].angle = theta_s*100 -60
            self.kit.servo[3].angle = theta_w*100 - 160
            self.kit.servo[4].angle =180- (theta_s*100 -75)
        except:
            print("Out of bounds.")
